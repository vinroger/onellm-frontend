          ...
          <div className="px-6 mx-auto max-w-7xl lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                No-code LLM Fine-Tuning & Deployment
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Optimize LLMs for your specific needs. Easily curate data, train
                models, do experiments, and deploy with confidence. Track
                performance for continuous improvement. All within your browser.
              </p>
            ...
            <div className="flow-root mt-16 sm:mt-24">
              <div className="p-2 -m-2 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                ...
                <video
                  ...
                  width={1832}
                  height={962}
                  className="rounded-lg shadow-2xl bg-white/5 ring-1 ring-white/10 "
                >
